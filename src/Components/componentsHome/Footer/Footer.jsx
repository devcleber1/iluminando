...
import LoadingComponent from '../../Loading'; // Adjust path if necessary
              ...
              <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3">
                <div className="col-span-2">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                    <div>
                      <Link to="/" className="block mt-2 text-sm font-menu text-black hover:text-white">Home</Link>
                      <Link to="/sobre" className="block mt-2 text-sm font-menu text-black hover:text-white">Quem somos</Link>
                      <Link to="/galeria" className="block mt-2 text-sm font-menu text-black hover:text-white">Galeria</Link>
                    </div>
                    <div>
                      <Link to="/oficinas" className="block mt-2 text-sm font-menu text-black hover:text-white">Oficinas</Link>
                      <Link to="/blog" className="block mt-2 text-sm font-menu text-black hover:text-white">Blog</Link>
                    </div>
                  </div>
                </div>
